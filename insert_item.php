...
$query = "INSERT INTO items (name, added_date, expiry_date, days_left, user_id, image_src, exact_time) VALUES ('$name', '$added_date', '$expiry_date', '$days_left', '$user_id', '$image', '$exact_time')";
